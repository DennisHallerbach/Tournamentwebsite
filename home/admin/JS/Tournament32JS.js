...
var liste = document.querySelectorAll("#Achtelfinale td");
...
if(liste.length >0){	
	for(var i = 0, len2=liste.length;i<len2;i++){
		let test = document.querySelectorAll("#Sechzehntelfinale #"+liste[i].textContent+ "sechzehn");	
